...
const DICT = {
  zh: {
    ...
    'chat.agent.prefix': '智能体：',
    'chat.agent.analyst': '智能体：数据分析师（即将推出）',
    'chat.agent.coming_soon': '即将推出',
  ...
  en: {
    ...
    'chat.agent.analyst': 'Agent: Data analyst (coming soon)',
    'chat.agent.coming_soon': 'Coming soon',
